...
const Forest = (props) => (
    <div id="forest">
        ...
        <div>
            <button type="button" class="btn btn-primary area1">Area 1</button>
        ...
        <div>
            <button type="button" class="btn btn-primary area2">Area 2</button>
        ...
        <div>
            <button type="button" class="btn btn-primary area3">Area 3</button>
